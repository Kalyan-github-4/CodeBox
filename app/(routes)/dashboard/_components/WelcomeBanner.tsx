...
const WelcomeBanner = () => {
    ...
    return (
        <div className="relative rounded-xl border-2 border-blue-500/30 bg-slate-900/80 backdrop-blur-sm overflow-hidden p-6">
            {/* Background effects */}
            ...
            <div className="flex flex-col md:flex-row items-center gap-6 relative z-10">
                ...
                <div className="relative">
                    <div className="absolute -inset-4 bg-blue-500/20 rounded-full blur-md opacity-60" />
                    <div className="relative p-4 rounded-2xl bg-slate-900/50 border-2 border-blue-500/30">
                        <Image
                            src="/machine.webp"
                            alt="robo"
                            height={80}
