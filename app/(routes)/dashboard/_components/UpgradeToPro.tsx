...
const UpgradeToPro = () => {
    return (
        <div className="relative p-6 border border-yellow-500/50 rounded-xl mt-8 w-full bg-slate-900/60 backdrop-blur-sm overflow-hidden group hover:border-yellow-500/80 transition-all duration-300">
            {/* Subtle gradient background */}
            <div className="absolute inset-0 bg-linear-to-b from-yellow-500/5 via-transparent to-transparent opacity-30"></div>

            {/* Animated border effect */}
            <div className="absolute inset-0 border-2 border-transparent rounded-xl group-hover:border-yellow-500/20 transition-all duration-500"></div>

            <div className="relative flex flex-col items-center">
                {/* Logo with glow */}
                <div className="mb-4 flex justify-center">
                    <div className="relative rounded-full border border-yellow-400/30 bg-yellow-900/30 p-4">
                        <div className="absolute -inset-2 rounded-full bg-yellow-500/20 blur-sm" />
                        <Image
                            src="/logo.png"
                            alt="Invite Friend"
                            width={56}
                ...
                {/* Subtext */}
                <p className="font-game text-gray-600 text-xs text-center mt-4">
