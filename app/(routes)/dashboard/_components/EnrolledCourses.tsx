            ...
            {enrolledCourses?.length === 0 ? (
                <div className="relative p-8 rounded-xl border-2 border-blue-500/30 bg-slate-900/60 
                    ...
                    <div className="absolute inset-0 opacity-10">
                        <div className="absolute top-1/4 left-1/4 w-16 h-16 border border-blue-500/20 rounded-full"></div>
                        <div className="absolute bottom-1/4 right-1/4 w-16 h-16 border border-purple-500/20 rounded-full"></div>
                    </div>

                    {/* Content */}
                    <div className="relative z-10 px-8 font-game">
                        {/* Animated icon */}
                        <div className="inline-flex p-4 rounded-full bg-blue-900/30 border border-blue-500/30 mb-6">
                            <Image 
                                src={'/books.png'} 
                                alt="book" 
                                width={70} 
